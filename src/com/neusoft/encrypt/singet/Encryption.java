...
public interface Encryption<T extends Enum<? extends Algorithm>> {
	 ...
	 */
	public byte[] encrypt(byte[] plain,T algorithm)throws NoSuchAlgorithmException;
	/**
	 ...
	 * @throws NotSuchMDAlgorithm
	 */
	public byte[] encrypt(String plain,T algorithm)throws NoSuchAlgorithmException;
	/**
